...
wget.callbacks.download_child_p = function(urlpos, parent, depth, start_url_parsed, iri, verdict, reason)
  ...
  if (string.match(url, maindiff) and not string.match(url, "https?://[^/]+/[^/]+/[^/]+/[^/]+/[^/]+/master/tree/")) or (string.match(url, maindiff) and not string.match(url, "https?://[^/]+/[^/]+/[^/]+/[^/]+/HEAD/tree/")) or (string.match(url, "cvs%.sourceforge%.net") and (string.match(url, "hideattic=") or string.match(url, "sortby=") or string.match(url, "sortdir=") or string.match(url, "pathrev=") or string.match(url, "content%-type=") or string.match(url, "r1=") or string.match(url, "annotate=") or string.match(url, "revision="))) or (string.match(url, "/"..itemvalue.."/"..itemvalue.."/"..itemvalue.."/") and string.match(url, "https?://accounts%.google%.com")) or string.match(url, "&amp;diformat=") or string.match(url, "&diformat=") or string.match(url, "%?force=True") or string.match(url, "sourceforge%.net/[^/]+/"..itemvalue.."/report_inappropriate") or string.match(url, "/_ew_/theme/sftheme/images/sftheme/[^/]+/forums_") or string.match(url, "%?r=http.+%?r=http") or string.match(url, "&r=http.+&r=http") or string.match(url, "%%26r%%3Dhttp.+%%26r%%3Dhttp") or string.match(url, "&r=http.+%%26r%%3Dhttp") or string.match(url, "&amp;stars=") or string.match(url, "&stars=") or string.match(url, "%?stars=") or string.match(url, "%%3E") or string.match(url, ">") or (string.match(url, "/_static_/") and string.match(url, "fsdn%.com")) or (string.match(url, "/1433869845/_ew_/") and string.match(url, "fsdn%.com")) then
    return false
  end
  
  if (downloaded[url] ~= true or addedtolist[url] ~= true) and not ((string.match(url, maindiff) and not string.match(url, "https?://[^/]+/[^/]+/[^/]+/[^/]+/[^/]+/master/tree/")) or (string.match(url, maindiff) and not string.match(url, "https?://[^/]+/[^/]+/[^/]+/[^/]+/HEAD/tree/")) or (string.match(url, "cvs%.sourceforge%.net") and (string.match(url, "hideattic=") or string.match(url, "sortby=") or string.match(url, "sortdir=") or string.match(url, "pathrev=") or string.match(url, "content%-type=") or string.match(url, "r1=") or string.match(url, "annotate=") or string.match(url, "revision="))) or (string.match(url, "/"..itemvalue.."/"..itemvalue.."/"..itemvalue.."/") and string.match(url, "https?://accounts%.google%.com")) or string.match(url, "&diformat=") or string.match(url, "/_ew_/theme/sftheme/images/sftheme/[^/]+/forums_") or string.match(url, "%?force=True") or string.match(url, "&amp;diformat=") or string.match(url, "sourceforge%.net/[^/]+/"..itemvalue.."/report_inappropriate") or string.match(url, "%?r=http.+%?r=http") or string.match(url, "&r=http.+&r=http") or string.match(url, "%%26r%%3Dhttp.+%%26r%%3Dhttp") or string.match(url, "&r=http.+%%26r%%3Dhttp") or string.match(url, "&amp;stars=") or string.match(url, "&stars=") or string.match(url, "%?stars=") or string.match(url, "%%3E") or string.match(url, ">") or (string.match(url, "/_static_/") and string.match(url, "fsdn%.com")) or (string.match(url, "/1433869845/_ew_/") and string.match(url, "fsdn%.com"))) then
...
wget.callbacks.get_urls = function(file, url, is_css, iri)
  ...
  local function check(url)
    ...
    elseif (downloaded[url] ~= true and addedtolist[url] ~= true) and not ((string.match(url, maindiff) and not string.match(url, "https?://[^/]+/[^/]+/[^/]+/[^/]+/[^/]+/master/tree/")) or (string.match(url, maindiff) and not string.match(url, "https?://[^/]+/[^/]+/[^/]+/[^/]+/HEAD/tree/")) or (string.match(url, "cvs%.sourceforge%.net") and (string.match(url, "hideattic=") or string.match(url, "sortby=") or string.match(url, "sortdir=") or string.match(url, "pathrev=") or string.match(url, "content%-type=") or string.match(url, "r1=") or string.match(url, "annotate=") or string.match(url, "revision="))) or (string.match(url, "/"..itemvalue.."/"..itemvalue.."/"..itemvalue.."/") and string.match(url, "https?://accounts%.google%.com")) or string.match(url, "&amp;diformat=") or string.match(url, "/_ew_/theme/sftheme/images/sftheme/[^/]+/forums_") or string.match(url, "%?force=True") or string.match(url, "sourceforge%.net/[^/]+/"..itemvalue.."/report_inappropriate") or string.match(url, "%?r=http.+%?r=http") or string.match(url, "&r=http.+&r=http") or string.match(url, "%%26r%%3Dhttp.+%%26r%%3Dhttp") or string.match(url, "&r=http.+%%26r%%3Dhttp") or string.match(url, "&amp;stars=") or string.match(url, "&stars=") or string.match(url, "%?stars=") or string.match(url, "%%3E") or string.match(url, ">") or (string.match(url, "/_static_/") and string.match(url, "fsdn%.com")) or (string.match(url, "/1433869845/_ew_/") and string.match(url, "fsdn%.com"))) then
      if string.match(url, "&amp;") then
        table.insert(urls, { url=string.gsub(url, "&amp;", "&") })
        added_urls = added_urls + 1
        addedtolist[url] = true
...
--  end
  ...
  if string.match(url, itemvalue) and not string.match(url, "https?://[^%.]+%.dl%.sourceforge%.net/") then
...
--      end
      ...
      for newurl in string.gmatch(html, '<a href=("[^"]+)">') do
        if not (string.match(newurl, '"https?://') or string.match(newurl, '"/') or string.match(newurl, '"#')) then
          if string.match(newurl, '"%?') and string.match(url, "%?") then
            check(string.match(url, "(https?://.+)%?")..string.match(newurl, '"(.+)'))
          elseif string.match(newurl, '"%?') and not string.match(url, "%?") then
            check(url..string.match(newurl, '"(.+)'))
